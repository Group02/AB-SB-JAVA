	...
	<div >
					...
					<div>
						<table>
							...
							<tr>
								...
								<td><span class="SIC"><form:input path="sicCode" class="background" size="14px" readonly="readonly" id="sic" value="${sicCode }"/> </span> </td>
							</tr>
							<tr>
								<td>Lead Contact</td>
								<td>
									<form:input path="leadContact" class="background" size="16px" readonly="readonly" id="leadcont" value="${leadContact }"/>
		...
		<!-- 						<td></td> -->
							...
							<tr>
								<td>Postcode</td>
								<td>
									<form:input path="postCode" class="background" size="16px" readonly="readonly" id="postCode" value="${postCode }"/>
